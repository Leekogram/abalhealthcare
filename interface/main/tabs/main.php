...
<div id="mainBox" <?php echo $disp_mainBox ?>>
    ...
    <div class="body_top">
        <a href="http://www.open-emr.org" title="OpenEMR <?php echo xla("Website"); ?>" target="_blank"><img class="logo" alt="openEMR small logo"  border="0" src="<?php echo $GLOBALS['images_static_relative']; ?>/menu-logo.jpeg"></a>
